...
public class AmmoDetailsSO : ScriptableObject
{
    ...
    [Tooltip("Sprite used for the ammo")]
    ...
    [Tooltip("Prefab for the ammo. If multiple prefabs are specified, then a random prefab from array will be used.")]
    ...
    [Tooltip("This is the minimum spread angle of the ammo -- A higher spread means less accuracy. A random spread is calculated between the min and max")]
    ...
    [Tooltip("This is the maximum spread angle of the ammo -- A higher spread means less accuracy. A random spread is calculated between the min and max")]
    ...
    [Tooltip("This is the minimum number of ammo that are spawned per shot. A random number of ammo are spawned between the min and max")]
    ...
    [Tooltip("This is the maximum number of ammo that are spawned per shot. A random number of ammo are spawned between the min and max")]
    ...
    [Tooltip("Minimum spawn interval time. The time interval in seconds between spawn ammo is a random value between the min and max")]
    ...
    [Tooltip("Maximum spawn interval time. The time interval in seconds between spawn ammo is a random value between the min and max")]
    ...
    [Tooltip("Selected if an ammo trail is required. If selected then the rest of the ammo trail values should be populated.")]
